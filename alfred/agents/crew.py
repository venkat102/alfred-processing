...
LITE_TASK_DESCRIPTION = (
	...
	"   - Validation rule / custom logic? -> Server Script\n"
	"     * script_type='DocType Event'\n"
	"     * reference_doctype=<Target DocType from step 1>\n"
	"     * doctype_event='before_save' or 'validate' or 'before_insert' as appropriate\n"
	"     * script body uses `doc.<field>` and calls `frappe.throw('<message>')` to reject\n"
